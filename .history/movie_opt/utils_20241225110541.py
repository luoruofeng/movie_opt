...
if __name__ == "__main__":
    print(calculate_based_on_length("1234567890"))  # 输出: 2
    print(calculate_based_on_length("12345678901")) # 输出: 3
    print(calculate_based_on_length("12345678901234567890"))  # 输出: 3
    print(calculate_based_on_length("123456789012345678901234567890"))  # 输出: 4
