...
def fix_video_timestamps(video_path):
    ...
    try:
        ...
        ffprobe_cmd = [
            "ffprobe", "-v", "error", "-show_entries", "packet=dts", "-select_streams", "v", "-of", "csv", video_path
        ]
        ...
        temp_output = "temp_fixed_timestamps.mp4"
...
def reencode_video_to_match(input_video_1, input_video_2):
    ...
    try:
        ...
        if encoding_info_1 == encoding_info_2:
            ...
            print("需要重新编码视频{input_video_2} 编码信息{encoding_info_2}")
