...
def adjust_video_timescale(video_path1, video_path2):
    ...
    if timescale1 != timescale2:
        ...
        modify_timescale(video_path2, video_path2, timescale1)
    else:
        print("Timescale values are the same, no modification needed.")


# 修复路径
video_path1 = r"C:\Users\luoruofeng\Desktop\test\视频片段\每行中文视频-Lion King 2 1998-en@cn-3\Lion King 2 1998-en@cn-3-9.mp4"
video_path2 = r"C:\Users\luoruofeng\Desktop\test\视频片段\每行中文视频-Lion King 2 1998-en@cn-3\Lion King 2 1998-en@cn-3-10.mp4"
