...
def fix_video_timestamps(video_path):
    ...
    #         "-select_streams", "v", "-of", "csv", video_path  # 去掉 f'"{video_path}"'
    #     ]
    ...
    #         if ',' in line:
    #             try:
    #                 # Attempt to parse the second value as an integer
    #                 dts_value = int(line.split(',')[1])
    #                 dts_values.append(dts_value)
    #             except ValueError:
...
# Example usage
video_path = "C:\\Users\\luoruofeng\\Desktop\\test\\视频片段\\Lion King 2 1998-en@cn-3.mkv"
