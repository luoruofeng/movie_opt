...
from movie_opt.commands.voice import  youdao_voice, create_mp3_by_clone_voice, clone_voice_conversion
...
def main():
    ...
    subparser_subtitle_convert_time = subparser_subtitle.add_parser("convert_time", help="将srt文件根据间隔时长分段为多个srt文件")
