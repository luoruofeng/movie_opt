...
def merge1(args):
    merge1_diff_type(args,1)
    merge1_diff_type(args,2)
    merge1_diff_type(args,3)
...
def merge1_diff_type(args,type):
    if type == 1:
        ...
        merge_mp4(args, folder_types,"中英对照")
    ...
    if type == 2:
        ...
        merge_mp4(args, folder_types,"跟读")
    ...
    if type == 3:
        ...
        merge_mp4(args, folder_types,"磨耳朵")

    if type == 4:
        cnen = os.path.join(os.path.dirname(resource_filename(__name__,".")),'static', "中英对照.mp4")
        cnen = os.path.join(os.path.dirname(resource_filename(__name__,".")),'static', "磨耳朵.mp4")
        cnen = os.path.join(os.path.dirname(resource_filename(__name__,".")),'static', "跟读.mp4")
