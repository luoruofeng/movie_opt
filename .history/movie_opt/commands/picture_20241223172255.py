    ...
    for segment in segment_json:
        ...
        if not os.path.exists(output_filename):
            ...
            try:
                ...
                # 例如： ffmpeg -i "C:\Users\luoruofeng\Desktop\test\test_subtitled.mkv" -ss 4048.590 -to 4106.720 -accurate_seek "C:\Users\luoruofeng\Desktop\test\视频片段\Lion King 2 1998-en@cn-29.mkv"
                command = [
                    "ffmpeg",
                    "-i", video,
                    "-ss", f"{start_seconds:.3f}",
